...
const COMMANDS: Command[] = [
  ...
  { id: 'filter-missing',     label: 'Filter: Missing CoinGecko data', shortcut: 'F4', run: (c) => { c.setFilter('missing_cg'); c.setRoute('table'); } },
  { id: 'filter-all',         label: 'Filter: Show all L2s',          shortcut: 'F5', run: (c) => c.setFilter('all') },
