...
const COMMANDS: Command[] = [
  ...
  { id: 'go-rwa',         label: 'Go: RWA',            shortcut: '4',  run: (c) => c.setRoute('rwa') },
  { id: 'go-compare',     label: 'Go: Compare (ADI vs Canton)', shortcut: '5', run: (c) => c.setRoute('compare') },
  { id: 'go-report',      label: 'Go: Report',         shortcut: '6',  run: (c) => c.setRoute('report') },
  { id: 'go-methodology', label: 'Go: Methodology',    shortcut: '7',  run: (c) => c.setRoute('methodology') },
